...
• Make sure your comparison is case insensitive.
 ...
 var current_users: string[] = ["admin", "john", "smith", "chris", "chloe"]
 var new_users: string[] = ["sam", "john", "smith", "robert", "mike"]
...
function checkDuplicate(current_users) {
   for (let index = 0; index < new_users.length; index++) {
      ...
      return console.log(`${new_users[index]} is already taken!`)};
   }
